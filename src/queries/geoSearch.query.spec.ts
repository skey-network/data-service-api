...
const testData: Db.TestCollection = {
  ...
  objects: [
    ...
    { id: 18, name: 'DATE_LINE', lat: 5.8695032870595885, lng: 179.90010655922714 },
    {
      id: 20,
      name: 'DATE_LINE_FAKE',
      lat: 5.8695032870595885,
      lng: 0.90010655922714
    },
    {
      id: 21,
      name: 'DATE_LINE_FAKE',
      lat: 5.8695032870595885,
      lng: 70.90010655922714
    },
    {
      id: 2,
      name: 'DATE_LINE_FAKE',
      lat: 5.8695032870595885,
      lng: -90.90010655922714
    }
  ]
}
...
const cases = [
  ...
  },
  {
    toString: () => 'date line',
    args: [
      3.3684537454993047, 176.56026289785768, 7.2184117578513725, -177.11161227007392
    ],
    expected: [18]
  }
]
